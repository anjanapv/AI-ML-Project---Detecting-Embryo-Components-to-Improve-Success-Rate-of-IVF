...
TRAIN_DIR="D:\College\Sem 4\Capstone\STORK-master\STORK-master\scripts\result"
#DATASET_DIR=../process #The directory where processed.tf records are located.
DATASET_DIR="D:\College\Sem 4\Capstone\STORK-master\STORK-master\scripts\process"

#'C:/ProgramData/Anaconda3/python.exe' train_image_classifier.py \
